...
class Event extends Model
{
    ...
    */
    ...
    public function getCategoryListAttribute()
    {
        ...
        return $this->category->pluck('id')->all(); //relationship category events
        //or ican do this
    ...
    {
        return $this->tags->pluck('name')->all(); //relationship tags events
    }
    ...
    {
      return $this->branch->pluck('name', 'id')->all();
    }

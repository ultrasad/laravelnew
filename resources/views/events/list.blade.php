              ...
              <div class="relative">
                ...
                <div class="no-overflow">
                  @if(is_file($event->image))
                    ...
                    <a href="{{ URL::to('/', rawurldecode($event->url_slug)) }}" title="{{ $event->title }}"><img src="/img/{{ $event->image }}?w=298" data-src="{{ $event->image }}" class="block center-margin relative img-responsive" alt="{{ $event->title }}" /></a>
                  @else
